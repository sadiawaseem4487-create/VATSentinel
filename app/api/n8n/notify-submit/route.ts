...
/**
 * Awaits the n8n webhook (no `after()`). Deferred work was unreliable on Vercel:
 * the first submit could return before the outbound POST ran, so the workflow
 * only appeared to start on a later request.
 */
